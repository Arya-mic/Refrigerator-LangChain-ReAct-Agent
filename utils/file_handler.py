...
#
# loader = TextLoader(
#     r"D:\课堂作业\大模型\LangChain-ReAct-Agent\data\fridge_usage.txt",
#     encoding="utf-8"
# )
# docs = loader.load()
# print(docs)
...
#     data_path = r"D:\课堂作业\大模型\LangChain-ReAct-Agent\data"
#
#     # 1️⃣ 找到所有txt文件
#     files = listdir_with_allowed_type(data_path, (".txt",))
#
#     print("找到的文件：", files)
#
#     # 2️⃣ 逐个计算MD5
